function Offspring = OperatorDE_2(Parent1,Parent2,Parent3,Parent4)
    %% Parameter setting
    ...
    if size(Parent4, 1) == 1
        ...
        Offspring(Site) = Offspring(Site) + F*(Parent4(Site)-Parent3(Site)) + K*(Parent2_temp(Site)-Offspring(Site));
    end
